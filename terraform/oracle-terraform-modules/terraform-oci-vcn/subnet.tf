module "public_subnet" {
  ...
  depends_on = [ module.public_subnet_sl,module.public_subnet_rt ]
...
module "private_app" {
  ...
  source = "./modules/subnet"
  depends_on = [ module.private_app_sl,module.private_app_rt ]
...
module "private_db" {
  ...
  source = "./modules/subnet"
  depends_on = [ module.private_db_sl,module.private_db_rt ]
...
module "private_exacs_client" {
  ...
  source = "./modules/subnet"
  depends_on = [ module.private_exacs_client_sl,module.private_exacs_client_rt ]
...
module "private_exacs_bkp" {
  count  = var.create_private_exacs ? 1 : 0
  source = "./modules/subnet"
  depends_on = [ module.private_exacs_bkp_sl,module.private_exacs_bkp_rt ]
...
module "private_oke" {
  ...
  source = "./modules/subnet"
  depends_on = [ module.private_oke_sl,module.private_oke_rt ]
...
module "private_gen1" {
  ...
  source = "./modules/subnet"
  depends_on = [ module.private_gen1_sl,module.private_gen1_rt ]
...
module "private_gen2" {
  ...
  source = "./modules/subnet"
  depends_on = [ module.private_gen2_sl,module.private_gen2_rt ]
